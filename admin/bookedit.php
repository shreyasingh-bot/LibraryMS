			...
			<div class="col-md-4">
				<form action="" method="post">
					<div class="form-group">
						<label for="mobile">Book ID:</label>
						<input type="text" name="book_no" value="<?php echo $id;?>" class="form-control" disabled required>
					</div>
					<div class="form-group">
...
<?php
	if(isset($_POST['update'])){
		$connection = mysqli_connect("localhost","root","");
		$db = mysqli_select_db($connection,"library");
		$query = "update book set name = '$_POST[book_name]',author = '$_POST[author]', publisher = '$_POST[publisher]',genre = '$_POST[genre]',price = '$_POST[price]' where id = $_GET[bn]";
		$query_run = mysqli_query($connection,$query);
